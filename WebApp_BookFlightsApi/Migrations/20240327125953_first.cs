        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhereItPasses = table.Column<List<string>>(type: "text[]", nullable: true),
                    DateDeparture = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    DateArrival = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    Type = table.Column<string>(type: "text", nullable: true),
                    NumerOfPassengers = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdTrip = table.Column<long>(type: "bigint", nullable: true),
